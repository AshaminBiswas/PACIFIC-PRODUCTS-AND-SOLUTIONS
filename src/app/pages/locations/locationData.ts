...
export const locations: Record<string, LocationData> = {
  delhi: {
    ...
    mapSrc: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d112130.34!2d76.994!3d28.514!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d19d582e38859%3A0x2cf5fe8e5c64b1e!2sGurugram%2C%20Haryana!5e0!3m2!1sen!2sin!4v1713550212891!5m2!1sen!2sin",
    meta: {
    ...
    stats: [
      ...
      { label: "Years in NCR", value: "10+", numericValue: 10, suffix: "+" },
      { label: "Sq. Ft. Installed", value: "2M+", numericValue: 2, suffix: "M+" },
      { label: "Corporate Clients", value: "80+", numericValue: 80, suffix: "+" },
    ],
    ...
    faqs: [
      ...
      { question: "Can you handle large commercial projects in Delhi NCR?", answer: "Absolutely. We've completed 120+ projects in NCR including Delhi Metro stations, corporate towers, and 5-star hotels." },
  ...
  mumbai: {
    ...
    stats: [
      ...
      { label: "Years Operating", value: "15+", numericValue: 15, suffix: "+" },
      { label: "Sq. Ft. Installed", value: "5M+", numericValue: 5, suffix: "M+" },
      { label: "Enterprise Clients", value: "200+", numericValue: 200, suffix: "+" },
    ],
    services: COMMON_SERVICES,
    industries: COMMON_INDUSTRIES,
  ...
  bangalore: {
    ...
    description: "Catering to India's tech capital, our Bangalore office specializes in corporate office solutions, IT park fit-outs, and tech campus facilities. We deliver precision-engineered restroom cubicles, interior solutions, and exterior cladding to Bangalore's most innovative companies and commercial spaces.",
    ...
    stats: [
      ...
      { label: "Years in Bangalore", value: "8+", numericValue: 8, suffix: "+" },
      { label: "Sq. Ft. Installed", value: "3M+", numericValue: 3, suffix: "M+" },
      { label: "Tech Clients", value: "90+", numericValue: 90, suffix: "+" },
    ],
    services: COMMON_SERVICES,
    industries: COMMON_INDUSTRIES,
    ...
    whyChoose: COMMON_WHY_CHOOSE,
    faqs: [
      { question: "Do you install restroom cubicles in IT parks in Bangalore?", answer: "Yes, we specialize in IT park and tech campus installations. We've completed projects at Infosys, Manyata Tech Park, Embassy Tech Village, and more." },
      ...
      { question: "Do you provide design consultation in Bangalore?", answer: "Yes, our Bangalore team includes design consultants who can visit your site, take measurements, and provide 3D renderings before manufacturing." },
  ...
  ahmedabad: {
    ...
    description: "Serving Gujarat and surrounding states with high-quality interior solutions for commercial, industrial, and institutional projects. Our Ahmedabad office is a key gateway for western India operations, delivering restroom cubicles, cladding, and locker systems to Gujarat's fastest-growing commercial ecosystem.",
    address: "GIDC Industrial Estate, Ahmedabad - 382424, Gujarat",
    phone: "+91 98185 92113",
    ...
    stats: [
      ...
      { label: "Years in Gujarat", value: "6+", numericValue: 6, suffix: "+" },
      { label: "Sq. Ft. Installed", value: "1.5M+", numericValue: 1.5, suffix: "M+" },
      { label: "Local Clients", value: "60+", numericValue: 60, suffix: "+" },
    ],
    services: COMMON_SERVICES,
    industries: COMMON_INDUSTRIES,
    ...
    whyChoose: COMMON_WHY_CHOOSE,
    faqs: [
      { question: "Do you provide cubicle solutions across Gujarat?", answer: "Yes, we serve all major cities in Gujarat including Ahmedabad, Surat, Vadodara, Rajkot, and Gandhinagar from our Ahmedabad operations center." },
      { question: "Can you handle industrial facility projects in GIDC areas?", answer: "Absolutely. We have extensive experience with industrial facility fit-outs in GIDC estates across Gujarat, including factories, warehouses, and processing plants." },
  ...
  uae: {
    ...
    description: "Expanding our global footprint across the Middle East, our Dubai office serves clients in UAE, Saudi Arabia, and other GCC countries. We deliver luxury-grade restroom cubicles, cladding systems, and commercial interior solutions that meet international standards and exceed expectations.",
    ...
    stats: [
      ...
      { label: "GCC Countries", value: "5+", numericValue: 5, suffix: "+" },
      { label: "Sq. Ft. Installed", value: "1M+", numericValue: 1, suffix: "M+" },
      { label: "International Clients", value: "45+", numericValue: 45, suffix: "+" },
    ],
    services: COMMON_SERVICES,
    industries: COMMON_INDUSTRIES,
    ...
    faqs: [
      ...
      { question: "What is the import process for your products to UAE?", answer: "We handle all logistics including export documentation, customs clearance, and delivery to site. Our Dubai warehouse maintains ready stock for faster project execution." },
    ],
