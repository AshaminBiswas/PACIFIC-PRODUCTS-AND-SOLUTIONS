        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
          ...
          >
            {banner?.title ? (
              ...
              <>Get In <span className="text-[#B5F823]">Touch</span></>
            )}
          </motion.h1>
          <motion.p
          ...
          >
            {banner?.subtitle || "Ready to start your project? Contact our team for expert consultation and detailed quotations"}
          </motion.p>
        </div>
      </section>
